...
export const TERM1_WEEKS: TermWeekContentCore[] = [...TERM1_PART_A, ...TERM1_PART_B].sort((a, b) => a.week - b.week);

export function getTerm1Week(n: number): TermWeekContentCore | undefined {
